# Title: Debugging PHP
Description: PHP debugging exercise for the BeCode Webdevelopment course
...
## Must-have features
Open up the php-debugging-original.php file, read the comments, fix the code blocks as requested in the comments.
